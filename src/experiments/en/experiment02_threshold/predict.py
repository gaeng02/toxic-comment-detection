...
RESULTS_DIR = os.path.join("results", dataset, "experiment02_threshold")
...
def main () :
    ...
    print(f"[INFO] Training GoodBadDistanceClassifier ...")
    ...
    config = {
        ...
        "k": clf.k,
        "threshold_distance": clf.threshold_distance,
        "break_label": clf.break_label,
    }
