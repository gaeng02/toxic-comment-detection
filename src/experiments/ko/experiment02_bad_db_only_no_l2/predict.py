...
from src.experiments.ko.experiment02_bad_db_only_no_l2.model import AdaptiveBadDBClassifier
...
RESULTS_DIR = os.path.join("results", dataset, "experiment02_bad_db_only_no_l2")
